...
public class GameModel implements Runnable {
    ...
    /**
     * this method starts the game by sending a socket to the client server 
     * and then switches views to the game board
    ...
    /**
     * fills the board with 0's which stand for an empty square,
